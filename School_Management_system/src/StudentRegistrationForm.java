...
public class StudentRegistrationForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (con != null) {
            ...
            String dpartment = jComboBox1.getSelectedItem().toString();
            ...
            if (!st_name.isEmpty() && !st_userName.isEmpty() && !email.isEmpty() && !age.isEmpty() && !phone.isEmpty() && !gender.isEmpty() && !date.isEmpty()) {
                try {
                    ...
                    if (select.equals("Students")) {
                        String sql = "INSERT INTO st_registration (name,user_name,email,age,Phone,gender,department,skills,date,address)VALUES('" + st_name + "','" + st_userName + "','" + email + "','" + age + "','" + phone + "','" + gender + "','" + dpartment + "','" + skills + "','" + date + "','" + address + "')";
                        st.execute(sql);
                        JOptionPane.showMessageDialog(null, "Srudent successfully added");
                    } else if (select.equals("Teachers")) {
                        String sql = "INSERT INTO teacher_registration (name,user_name,email,age,Phone,gender,department,skills,date,address)VALUES('" + st_name + "','" + st_userName + "','" + email + "','" + age + "','" + phone + "','" + gender + "','" + dpartment + "','" + skills + "','" + date + "','" + address + "')";
                        st.execute(sql);
